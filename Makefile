...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ? 12 21 14:15:51 2017
# Project:  ABBCCoin.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile ABBCCoin.pro
#############################################################################
...
Makefile: ABBCCoin.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile ABBCCoin.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/ABBCCoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/ABBCCoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/ABBCCoin/src/leveldb/libleveldb.a: FORCE
